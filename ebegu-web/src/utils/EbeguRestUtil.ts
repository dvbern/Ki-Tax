...
export class EbeguRestUtil {
    ...
    private kindToRestObject(restKind: any, kind: TSKind): any {
        ...
        restKind.geteilteElterlicheSorgeObhut = kind.geteilteElterlicheSorgeObhut;
    ...
    private parseKind(kindTS: TSKind, kindFromServer: any): TSKind {
        if (kindFromServer) {
            ...
            kindTS.geteilteElterlicheSorgeObhut = kindFromServer.geteilteElterlicheSorgeObhut;
