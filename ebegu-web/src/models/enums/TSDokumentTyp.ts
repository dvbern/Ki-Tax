...
export enum TSDokumentTyp {
    ...
    FACHSTELLENBEST_SOZ = 'FACHSTELLENBEST_SOZ',
    FACHSTELLENBEST_BEH = 'FACHSTELLENBEST_BEH',
    ...
    NACHWEIS_UNREG_ARBEITSZ = 'NACHWEIS_UNREG_ARBEITSZ',
    NACHWEIS_LANG_ARBEITSWEG = 'NACHWEIS_LANG_ARBEITSWEG',
    NACHWEIS_SONSTIGEN_ZUSCHLAG = 'NACHWEIS_SONSTIGEN_ZUSCHLAG',
    NACHWEIS_GLEICHE_ARBEITSTAGE_BEI_TEILZEIT = 'NACHWEIS_GLEICHE_ARBEITSTAGE_BEI_TEILZEIT',
    NACHWEIS_FIXE_ARBEITSZEITEN = 'NACHWEIS_FIXE_ARBEITSZEITEN',
    ...
    NACHWEIS_EINKOMMENSSITUATION_MONAT = 'NACHWEIS_EINKOMMENSSITUATION_MONAT',
    DIV = 'DIV',
