...
public enum MergeFieldFerienbetreuung implements MergeFieldProvider {
	...
	sockelbeitrag(new SimpleMergeField<>("sockelbeitrag", BIGDECIMAL_CONVERTER)),
	beitraegeNachAnmeldungen(new SimpleMergeField<>("beitraegeNachAnmeldungen", BIGDECIMAL_CONVERTER)),
	vorfinanzierteKantonsbeitraege(new SimpleMergeField<>("vorfinanzierteKantonsbeitraege", BIGDECIMAL_CONVERTER)),
	eigenleistungenGemeinde(new SimpleMergeField<>("eigenleistungenGemeinde", BIGDECIMAL_CONVERTER)),
