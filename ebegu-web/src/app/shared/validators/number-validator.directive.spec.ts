...
describe('numberValidator', () => {
    it('should return an error if 1.5 ist tested for an integer', () => {
        const test = numberValidator(ValidationType.INTEGER)(
            new FormControl('1.5')
        );
    ...
    it('should return an error if 1.2 ist tested for half number', () => {
        const test = numberValidator(ValidationType.HALF)(
            new FormControl('1.2')
        );
    ...
    it('should return an error if "-1" ist tested for positive integer', () => {
        const test = numberValidator(ValidationType.POSITIVE_INTEGER)(
            new FormControl('-1')
        );
