...
export enum TSEinstellungKey {
    ...
    TAGESSCHULE_ENABLED_FOR_MANDANT = 'TAGESSCHULE_ENABLED_FOR_MANDANT' as any,
    TAGESSCHULE_ENABLED_FOR_GEMEINDE = 'TAGESSCHULE_ENABLED_FOR_GEMEINDE' as any,
    FERIENINSEL_ENABLED_FOR_GEMEINDE = 'FERIENINSEL_ENABLED_FOR_GEMEINDE' as any,
    BETREUUNGSGUTSCHEINE_ENABLED_FOR_GEMEINDE = 'BETREUUNGSGUTSCHEINE_ENABLED_FOR_GEMEINDE' as any,
}
...
export function getTSEinstellungenKeys(): Array<TSEinstellungKey> {
    return [
        ...
        TSEinstellungKey.TAGESSCHULE_ENABLED_FOR_MANDANT,
        TSEinstellungKey.TAGESSCHULE_ENABLED_FOR_GEMEINDE,
        TSEinstellungKey.FERIENINSEL_ENABLED_FOR_GEMEINDE,
        TSEinstellungKey.BETREUUNGSGUTSCHEINE_ENABLED_FOR_GEMEINDE,
    ];
}
