...
public enum MergeFieldInstitutionen implements MergeFieldProvider {
	...
	ausserordentlicheOeffnungszeitenTitle(new SimpleMergeField<>("ausserordentlicheOeffnungszeitenTitle", STRING_CONVERTER)),
	...
	ausserordentlicheOeffnungszeiten(new SimpleMergeField<>("ausserordentlicheOeffnungszeiten", STRING_CONVERTER)),
