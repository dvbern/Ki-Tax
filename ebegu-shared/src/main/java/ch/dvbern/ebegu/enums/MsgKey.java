...
public enum MsgKey {
	...
	ERWERBSPENSUM_KEIN_ANSPRUCH(RuleKey.ERWERBSPENSUM),
	...
	FAMILIENSITUATION_KONKUBINAT_MSG(RuleKey.ZIVILSTANDSAENDERUNG),
	...
	ERWEITERTE_BEDUERFNISSE_MSG(RuleKey.ERWEITERTE_BEDUERFNISSE),

	ZUSATZGUTSCHEIN_JA_KITA(RuleKey.ZUSATZGUTSCHEIN),
	ZUSATZGUTSCHEIN_JA_TFO(RuleKey.ZUSATZGUTSCHEIN),
	ZUSATZGUTSCHEIN_NEIN_NICHT_IN_GEMEINDE(RuleKey.ZUSATZGUTSCHEIN),
	ZUSATZGUTSCHEIN_NEIN_SOZIALHILFE(RuleKey.ZUSATZGUTSCHEIN),
	ZUSATZGUTSCHEIN_NEIN_SCHULSTUFE(RuleKey.ZUSATZGUTSCHEIN);
