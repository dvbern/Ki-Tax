...
public class ExternalClient extends AbstractEntity {
	...
	private final @NotEmpty String clientName;

	@Nonnull
	@Enumerated(EnumType.STRING)
	@Column(nullable = false, updatable = false, length = Constants.DB_DEFAULT_MAX_LENGTH)
	private final ExternalClientType type;
