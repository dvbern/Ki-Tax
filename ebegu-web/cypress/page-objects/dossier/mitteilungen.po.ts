...
const getMutationsmeldungOeffnenButton = (mitteilungsIndex: number) => {
    return cy.getByData('container.mitteilung#' + mitteilungsIndex);
};
...
export const MitteilungenPO = {
    ...
    getMutationsmeldungOeffnenButton
};
