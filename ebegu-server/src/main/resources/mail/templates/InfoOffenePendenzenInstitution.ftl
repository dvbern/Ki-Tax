...
Subject: <@base64Header>kiBon – Offene Pendenzen / FR_Offene Pendenzen (${institutionStammdaten.institution.name})</@base64Header>
...
${templateConfiguration.mailCss}
    ...
    <title>kiBon – Offene Pendenzen / FR_Offene Pendenzen (${institutionStammdaten.institution.name})</title>
...
<div>
	...
	<p>
		FR_Wir möchten Sie darüber informieren, dass für Ihre Institution ${institutionStammdaten.institution.name} in kiBon Pendenzen offen sind. <br>
		Sie können diese
		<a href="<#if configuration.clientUsingHTTPS>https://<#else>http://</#if>${configuration.hostname}/pendenzenBetreuungen">hier</a>
		einsehen.
	</p>
