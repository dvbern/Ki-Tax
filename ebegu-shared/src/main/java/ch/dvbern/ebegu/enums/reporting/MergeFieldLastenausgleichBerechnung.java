...
public enum MergeFieldLastenausgleichBerechnung implements MergeFieldProvider {
	...
	bgMitSelbstbehaltTitel(new SimpleMergeField<>("belegungenMitSelbstbehaltTitel", STRING_CONVERTER)),
	...
	bgOhneSelbstbehaltTitel(new SimpleMergeField<>("belegungenOhneSelbstbehaltTitel", STRING_CONVERTER)),
