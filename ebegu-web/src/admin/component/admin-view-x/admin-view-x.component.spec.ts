...
describe('AdminViewXComponent', () => {
    ...
    applicationPropertyRSSpy.getAllApplicationProperties.and.resolveTo(
        {} as any
    );
    ...
    const matDialogSpy = jasmine.createSpyObj<MatDialog>(MatDialog.name, [
        'open'
    ]);
