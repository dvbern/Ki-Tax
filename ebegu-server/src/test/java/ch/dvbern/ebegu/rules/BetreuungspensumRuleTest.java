...
public class BetreuungspensumRuleTest {
	...
	public void testKitaNormalfall() {
		Betreuung betreuung = EbeguRuleTestsHelper.createBetreuungWithPensum(TestDataUtil.START_PERIODE, TestDataUtil.ENDE_PERIODE, BetreuungsangebotTyp.KITA,
			60, BigDecimal.valueOf(500.50));
		Assert.assertNotNull(betreuung.getKind().getGesuch().getGesuchsteller1());
		betreuung.getKind().getGesuch().getGesuchsteller1().addErwerbspensumContainer(TestDataUtil.createErwerbspensum(TestDataUtil.START_PERIODE,
			TestDataUtil.ENDE_PERIODE, 60, 0));
	...
	public void testKitaMitRestanspruch() {
		Betreuung betreuung = EbeguRuleTestsHelper.createBetreuungWithPensum(TestDataUtil.START_PERIODE, TestDataUtil.ENDE_PERIODE, BetreuungsangebotTyp.KITA,
			60, BigDecimal.valueOf(500));
		Assert.assertNotNull(betreuung.getKind().getGesuch().getGesuchsteller1());
		betreuung.getKind().getGesuch().getGesuchsteller1().addErwerbspensumContainer(TestDataUtil.createErwerbspensum(TestDataUtil.START_PERIODE,
			TestDataUtil.ENDE_PERIODE, 80, 0));
		List<VerfuegungZeitabschnitt> result = calculate(betreuung);
	...
	public void testZweiKitas() {
		Betreuung betreuung1 = EbeguRuleTestsHelper.createBetreuungWithPensum(TestDataUtil.START_PERIODE, TestDataUtil.ENDE_PERIODE, BetreuungsangebotTyp
			.KITA, 60, BigDecimal.valueOf(600));
		Betreuung betreuung2 = EbeguRuleTestsHelper.createBetreuungWithPensum(TestDataUtil.START_PERIODE, TestDataUtil.ENDE_PERIODE, BetreuungsangebotTyp
			.KITA, 40, BigDecimal.valueOf(400));
		...
		betreuung1.getKind().getGesuch().getGesuchsteller1().addErwerbspensumContainer(TestDataUtil.createErwerbspensum(TestDataUtil.START_PERIODE,
			TestDataUtil.ENDE_PERIODE, 80, 0));
		...
		//Nach dem Berechnen des Rests ist der Rest im  im Feld AnspruchspensumRest gesetzt, Anspruchsberechtigtes Pensum ist noch 0 da noch nciht berechnet
		// fuer 2.Betr.
		...
		betreuung2.getKind().getGesuch().getGesuchsteller1().addErwerbspensumContainer(TestDataUtil.createErwerbspensum(TestDataUtil.START_PERIODE,
			TestDataUtil.ENDE_PERIODE, 80, 0));
		...
		Assert.assertEquals(20, resultBetr2.get(0).getAnspruchberechtigtesPensum()); // Nach der Berechnung des Anspruchs kann der Anspruch nicht hoeher sein
		...
		Assert.assertEquals(0, resultBetr2.get(0).getAnspruchspensumRest()); // Nach dem initialisieren fuer das nachste Betreuungspensum ist der noch
		// verbleibende restanspruch 0
	}

	@Test
	public void testRestanspruchKitaTagiKita() {
		//Teste ob der Restanspruch richtig berechnet wird wenn die erste Betreuung eine Kita ist, gefolgt von einer Tagi fuer Schulkinder, gefolgt von einer
		// Kita
		Betreuung betreuung1 = EbeguRuleTestsHelper.createBetreuungWithPensum(TestDataUtil.START_PERIODE, TestDataUtil.ENDE_PERIODE, BetreuungsangebotTyp
			.KITA, 60, BigDecimal.valueOf(600));
		Betreuung betreuung2 = EbeguRuleTestsHelper.createBetreuungWithPensum(TestDataUtil.START_PERIODE, TestDataUtil.ENDE_PERIODE, BetreuungsangebotTyp
			.TAGI, 40, BigDecimal.valueOf(400));
		Betreuung betreuung3 = EbeguRuleTestsHelper.createBetreuungWithPensum(TestDataUtil.START_PERIODE, TestDataUtil.ENDE_PERIODE, BetreuungsangebotTyp
			.KITA, 40, BigDecimal.valueOf(400));
		Assert.assertNotNull(betreuung1.getKind().getGesuch().getGesuchsteller1());
		Assert.assertNotNull(betreuung2.getKind().getGesuch().getGesuchsteller1());
		...
		// Kita 2: Reicht nicht mehr ganz
		betreuung3.getKind().getGesuch().getGesuchsteller1().addErwerbspensumContainer(TestDataUtil.createErwerbspensum(TestDataUtil.START_PERIODE,
			TestDataUtil.ENDE_PERIODE, 80, 0));
		...
		Assert.assertEquals(1, result.size());
		Assert.assertEquals(Integer.valueOf(80), result.get(0).getErwerbspensumGS1());
		Assert.assertEquals(BigDecimal.valueOf(40), result.get(0).getBetreuungspensum());
		Assert.assertEquals(20, result.get(0).getAnspruchberechtigtesPensum()); // Nach der Berechnung des Anspruchs kann der Anspruch nicht hoeher sein als
		// der Restanspruch (20)
		...
		Assert.assertEquals(BigDecimal.valueOf(20), result.get(0).getBgPensum());
		...
		Assert.assertEquals(0, result.get(0).getAnspruchspensumRest()); // Nach dem initialisieren fuer das nachste Betreuungspensum ist der noch verbleibende
		// restanspruch 0
	}
	...
	public void testTagesfamilienMitTiefemErwerbspensum() {
		...
		Betreuung betreuung = EbeguRuleTestsHelper.createBetreuungWithPensum(TestDataUtil.START_PERIODE,
			TestDataUtil.ENDE_PERIODE, BetreuungsangebotTyp.TAGESFAMILIEN, 80, BigDecimal.valueOf(800));
		Assert.assertNotNull(betreuung.getKind().getGesuch().getGesuchsteller1());
		betreuung.getKind().getGesuch().getGesuchsteller1().addErwerbspensumContainer(TestDataUtil.createErwerbspensum(TestDataUtil.START_PERIODE,
			TestDataUtil.ENDE_PERIODE, 60, 0));
		List<VerfuegungZeitabschnitt> result = calculate(betreuung);
