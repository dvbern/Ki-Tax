...
export class LocalLoginComponent {
    ...
    private createUsersOfBothParisAndLondon(): void {
        ...
        this.juristParisLondon = new TSBenutzer('Julia',
            ...
            undefined,
            [this.gemeindeParis, this.gemeindeLondon]);
        this.adminFerienbetreuungGemeindeParisundLondon = new TSBenutzer('Valentin',
            'Burgener',
            'buva',
            'password1',
            ...
            undefined,
            [this.gemeindeParis, this.gemeindeLondon]);
        this.sachbearbeiterinFerienbetreuungGemeindeParisundLondon = new TSBenutzer('Christoph',
            'Hütter',
            'huch',
            'password1',
