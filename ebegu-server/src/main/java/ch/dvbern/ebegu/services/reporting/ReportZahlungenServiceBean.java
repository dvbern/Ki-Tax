...
public class ReportZahlungenServiceBean extends AbstractReportServiceBean implements ReportZahlungenService {
    ...
    private final ReportZahlungenExcelConverter zahlungenConverter = new ReportZahlungenExcelConverter();
    ...
    public static ZahlungenDataRow zahlungToDataRow(
        ...
        row.setZahlungsFaelligkeitsDatum(zahlungsauftrag.getDatumFaellig());
