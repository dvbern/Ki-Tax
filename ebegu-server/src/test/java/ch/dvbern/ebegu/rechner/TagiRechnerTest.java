...
public class TagiRechnerTest extends AbstractBGRechnerTest {
	...
	public void testEinTagHohesEinkommenAnspruch15() {
		...
		Assert.assertEquals(new BigDecimal("88.10"), calculate.getVerguenstigung());
	}
	...
	public void testTeilmonatMittleresEinkommen() {
		...
		Assert.assertEquals(new BigDecimal("462.70"), calculate.getVerguenstigung());
	}
	...
	public void testTeilmonatMittleresEinkommen50() {
		...
		Assert.assertEquals(new BigDecimal("581.35"), calculate.getVerguenstigung());
	}
	...
	public void testGanzerMonatZuWenigEinkommen() {
		...
		Assert.assertEquals(new BigDecimal("1995.00"), calculate.getVerguenstigung());
	}
