...
public class ZivilstandsaenderungAbschnittRule extends AbstractAbschnittRule {
	...
	protected List<VerfuegungZeitabschnitt> createVerfuegungsZeitabschnitte(@Nonnull AbstractPlatz platz) {
		...
		if (familiensituation.getAenderungPer() != null && familiensituationErstgesuch != null &&
			...
			abschnittNachMutation.getBgCalculationInput().addBemerkung(ruleKey, msgKey, getLocale());
			...
			abschnittKonkubinat2GS.getBgCalculationInput().addBemerkung(ruleKey, MsgKey.FAMILIENSITUATION_KONKUBINAT_MSG, getLocale());
	...
	private VerfuegungZeitabschnitt createVerfuegungZeitabschnittForZivilstand(
		...
		abschnitt.getBgCalculationInput().setHasSecondGesuchstellerForFinanzielleSituation(
