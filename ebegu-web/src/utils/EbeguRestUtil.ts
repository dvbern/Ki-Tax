...
export class EbeguRestUtil {
    ...
    public parseFinanzielleSituationResultate(
        ...
        if (finanzielleSituationResultateFromServer) {
            ...
            finanzielleSituationResultateDTO.vermoegenGS1 = finanzielleSituationResultateFromServer.vermoegenGS1;
            finanzielleSituationResultateDTO.vermoegenGS2 = finanzielleSituationResultateFromServer.vermoegenGS2;
