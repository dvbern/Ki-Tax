...
public abstract class AbstractEbeguTest {
	...
	public static Archive<?> createTestArchive(@Nullable Class[] classesToAdd) {
		...
		WebArchive webArchive = ShrinkWrap.create(WebArchive.class, "test.war")
			...
			.addAsResource("mail/templates/de/InfoBetreuungAbgelehnt.ftl", "mail/templates/de/InfoBetreuungAbgelehnt_de.ftl")
			.addAsResource("mail/templates/de/InfoBetreuungenBestaetigt.ftl", "mail/templates/InfoBetreuungenBestaetigt_de.ftl")
			.addAsResource("mail/templates/de/InfoBetreuungGeloescht.ftl", "mail/templates/InfoBetreuungGeloescht_de.ftl")
			.addAsResource("mail/templates/de/InfoBetreuungVerfuegt.ftl", "mail/templates/InfoBetreuungVerfuegt_de.ftl")
			.addAsResource("mail/templates/de/InfoMahnung.ftl", "mail/templates/InfoMahnung_de.ftl")
			.addAsResource("mail/templates/de/InfoVerfuegtGesuch.ftl", "mail/templates/InfoVerfuegtGesuch_de.ftl")
			.addAsResource("mail/templates/de/InfoVerfuegtMutation.ftl", "mail/templates/InfoVerfuegtMutation_de.ftl")
			.addAsResource("mail/templates/de/WarnungGesuchNichtFreigegeben.ftl", "mail/templates/WarnungGesuchNichtFreigegeben_de.ftl")
			.addAsResource("mail/templates/de/WarnungFreigabequittungFehlt.ftl", "mail/templates/WarnungFreigabequittungFehlt_de.ftl")
			.addAsResource("mail/templates/de/InfoGesuchGeloescht.ftl", "mail/templates/InfoGesuchGeloescht_de.ftl")
			.addAsResource("mail/templates/de/BenutzerEinladung.ftl", "mail/templates/BenutzerEinladung_de.ftl")
