...
////			mutation.setFinanzielleSituationContainer(this.getFinanzielleSituationContainer().copyFinanzielleSituationContainer(new FinanzielleSituationContainer(), this));
////		}
