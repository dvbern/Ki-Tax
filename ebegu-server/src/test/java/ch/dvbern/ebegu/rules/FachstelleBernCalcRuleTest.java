 ...
 */
public class FachstelleBernCalcRuleTest {
	...
	void pensumTooLowSprachlicheIntegrationShouldHaveAnsprch() {
		...
		Assertions.assertFalse(abschnitt.getBemerkungenDTOList().isEmpty());
	...
	void pensumTooLowWithSprachlicheIntegrationShouldHaveAnspruchAfterBetreuungStart() {
		...
		Assertions.assertFalse(abschnitt1.getBemerkungenDTOList().isEmpty());
		...
		Assertions.assertFalse(abschnitt2.getBemerkungenDTOList().isEmpty());
	...
	void pensumTooLowWithSprachlicheIntegrationShouldHaveAnspruchDuringBetreuungenOnlyWithMultiplePensen() {
		...
		Assertions.assertFalse(abschnitt3.getBemerkungenDTOList().isEmpty());
		...
		Assertions.assertFalse(abschnitt4.getBemerkungenDTOList().isEmpty());
