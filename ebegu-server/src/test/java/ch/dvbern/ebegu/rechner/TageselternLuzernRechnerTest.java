...
public class TageselternLuzernRechnerTest extends AbstractLuzernRechnerTest {
	...
	public void testBabyMitEingewoehnung() {
		...
		//expected pauschale * verguenstigung / vollkosten => 500 * 205.60 / 367.55 = 279.66
		testValues.expectedGutscheinEingewoehnung = BigDecimal.valueOf(279.66);

		//expected verguenstigung = gutschein pro Monat + gutschein eingewoehnung => 205.59 + 279.66 = 485.24 (485.25 auf 5rp gerundet)
