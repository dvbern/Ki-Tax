...
public enum MergeFieldLastenausgleichBerechnung implements MergeFieldProvider {
	...
	bgTotalGemaessStichtagTitle(new SimpleMergeField<>("bgTotalGemaessStichtagTitle", STRING_CONVERTER)),
	...
	totalEingabeLastenausgleich(new SimpleMergeField<>("totalEingabeLastenausgleich", BIGDECIMAL_CONVERTER)),
	kostenProHundertProzentPlatz(new SimpleMergeField<>("kostenProHundertProzentPlatz", BIGDECIMAL_CONVERTER)),
	totalBelegungMitSelbstbehalt(new SimpleMergeField<>("totalBelegungMitSelbstbehalt", PERCENT_CONVERTER)),
	totalGutscheineMitSelbstbehalt(new SimpleMergeField<>("totalGutscheineMitSelbstbehalt", BIGDECIMAL_CONVERTER)),
	kostenProHundertProzentPlatzMitSelbstbehalt(new SimpleMergeField<>("kostenProHundertProzentPlatzMitSelbstbehalt", BIGDECIMAL_CONVERTER)),
	selbstbehaltGemeinde(new SimpleMergeField<>("selbstbehaltGemeinde", BIGDECIMAL_CONVERTER)),
	eingabeLastenausgleichMitSelbstbehalt(new SimpleMergeField<>("eingabeLastenausgleichMitSelbstbehalt", BIGDECIMAL_CONVERTER)),
