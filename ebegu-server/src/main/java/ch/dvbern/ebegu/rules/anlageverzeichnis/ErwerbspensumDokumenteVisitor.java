...
public class ErwerbspensumDokumenteVisitor implements MandantVisitor<AbstractDokumente<Erwerbspensum, LocalDate>> {

	public AbstractDokumente<Erwerbspensum, LocalDate> getErwerbspensumeDokumenteForMandant(@NotNull Mandant mandant) {
		return mandant.getMandantIdentifier().accept(this);
	}

	@Override
	public AbstractDokumente<Erwerbspensum, LocalDate> visitBern() {
	...
	@Override
	public AbstractDokumente<Erwerbspensum, LocalDate> visitSolothurn() {
		return new BernErwerbspensumDokumente();
	}
