	...
	public static Archive<?> createTestArchive(@Nullable Class[] classesToAdd) {
		...
		WebArchive webArchive = ShrinkWrap.create(WebArchive.class, "test.war")
			...
			.addPackages(true, "ch/dvbern/ebegu/reporting")
				.addPackages(true, "ch/dvbern/ebegu/nesko")
			...
			.addAsResource("reporting/GesuchStichtag_DE.xlsx", "reporting/GesuchStichtag_DE.xlsx")
			.addAsResource("reporting/GesuchStichtag_FR.xlsx", "reporting/GesuchStichtag_FR.xlsx")
			.addAsResource("reporting/GesuchZeitraum_DE.xlsx", "reporting/GesuchZeitraum_DE.xlsx")
			.addAsResource("reporting/GesuchZeitraum_FR.xlsx", "reporting/GesuchZeitraum_FR.xlsx")
			...
			.addAsResource("mail/templates/BenutzerEinladung_de.ftl", "mail/templates/BenutzerEinladung_de.ftl")
