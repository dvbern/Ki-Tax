...
@Retention(RUNTIME)
@Constraint(validatedBy = CheckBetreuungMitteilungZeitraumInGesuchsperiodeValidator.class)
@Documented
public @interface CheckBetreuungMitteilungZeitraumInGesuchsperiode {
