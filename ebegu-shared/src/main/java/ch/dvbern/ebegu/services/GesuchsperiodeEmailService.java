...
public interface GesuchsperiodeEmailService {

	/**
	 * Speichert alle Dossiers, an die eine Email versendet werden muss in GesuchsperiodeMassenversand.
	 * Diese wird später durch einen Batch Job abgearbeitet
	 */
