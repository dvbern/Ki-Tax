...
VALUES (UNHEX(REPLACE('d3a81288-5cc7-11ec-93ed-f4390979fa3e', '-','')), UNHEX(REPLACE('e3736eb8-6eef-40ef-9e52-96ab48d8f220', '-', '')),'2021-12-14 12:00:00', '2021-12-14 12:00:00', 'flyway', 'flyway', 0, null, 'AUSZAHLUNG_AN_ELTERN', 'false');

# solothurn
INSERT INTO application_property (id, mandant_id, timestamp_erstellt, timestamp_mutiert, user_erstellt, user_mutiert, version, vorgaenger_id, name, value)
VALUES (UNHEX(REPLACE('4d759f85-5cc8-11ec-93ed-f4390979fa3e', '-','')), UNHEX(REPLACE('7781a6bb-5374-11ec-98e8-f4390979fa3e', '-', '')),'2021-12-14 12:00:00', '2021-12-14 12:00:00', 'flyway', 'flyway', 0, null, 'AUSZAHLUNG_AN_ELTERN', 'false');
