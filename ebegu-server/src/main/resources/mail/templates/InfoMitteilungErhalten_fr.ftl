...
Subject: <@base64Header>FR_kiBon - Neue Nachricht der Gemeinde ${mitteilung.dossier.gemeinde.name}</@base64Header>
...
${templateConfiguration.mailCss}
    ...
    <title>FR_kiBon - Neue Nachricht der Gemeinde ${mitteilung.dossier.gemeinde.name}</title>
