...
declare type BroadcastMessageType =
    | TSHTTPEvent
    | TSVersionCheckEvent
    | TSMessageEvent;
...
export class BroadcastService {
    private readonly broadcaster = new Subject<
    ...
    public on$<T extends BroadcastMessageType>(
        type: T
    ): Observable<BroadcastMessage<BroadcastMessageType>> {
