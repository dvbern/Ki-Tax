...
VALUES (UNHEX(REPLACE('d3a81288-5cc7-11ec-93ed-f4390979fa3e', '-', '')),
...
INSERT INTO application_property (id, mandant_id, timestamp_erstellt, timestamp_mutiert, user_erstellt, user_mutiert,
								  version, vorgaenger_id, name, value)
VALUES (UNHEX(REPLACE('4d759f85-5cc8-11ec-93ed-f4390979fa3e', '-', '')),
...
INSERT INTO application_property (id, mandant_id, timestamp_erstellt, timestamp_mutiert, user_erstellt, user_mutiert,
								  version, vorgaenger_id, name, value)
VALUES (UNHEX(REPLACE('522c58af-5cc8-11ec-93ed-f4390979fa3e', '-', '')),
