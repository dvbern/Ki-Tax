...
-- Sozialdienst
INSERT INTO sozialdienst (id,timestamp_erstellt,timestamp_mutiert,user_erstellt,user_mutiert,version,vorgaenger_id,name,status,mandant_id) VALUES (UNHEX(REPLACE('f44a68f2-dda2-4bf2-936a-68e20264b620', '-', '')),'2021-02-15 09:48:18','2021-02-15 10:11:35','flyway','flyway',0,null,'BernerSozialdienst','AKTIV', UNHEX(REPLACE('e3736eb8-6eef-40ef-9e52-96ab48d8f220', '-', '')));
INSERT INTO adresse (id,timestamp_erstellt,timestamp_mutiert,user_erstellt,user_mutiert,version,vorgaenger_id,gueltig_ab,gueltig_bis,gemeinde,hausnummer,land,organisation,ort,plz,strasse,zusatzzeile) VALUES (UNHEX(REPLACE('a805a101-4200-473a-accc-bbb423ea1999', '-', '')),'2021-02-15 09:48:18','2021-02-15 10:11:35','flyway','flyway',1,null,'1000-01-01','9999-12-31',null,'2','CH','Bern Sozialdienst','Paris','3000','Sozialdienst Strasse',null);
INSERT INTO sozialdienst_stammdaten (id,timestamp_erstellt,timestamp_mutiert,user_erstellt,user_mutiert,version,vorgaenger_id,mail,telefon,webseite,adresse_id,sozialdienst_id) VALUES (UNHEX(REPLACE('0f1c6b9e-37de-4c10-8ddc-9514fb840f5f', '-', '')),'2021-02-15 09:48:18','2021-02-15 09:48:18','flyway','flyway',0,null,'test@mailbucket.dvbern.ch','078 898 98 98','http://test.dvbern.ch',UNHEX(REPLACE('a805a101-4200-473a-accc-bbb423ea1999', '-', '')),UNHEX(REPLACE('f44a68f2-dda2-4bf2-936a-68e20264b620', '-', '')));