...
import {DvSwitchComponent} from './dv-switch.component';
...
describe('fallToolbar', () => {
    ...
    let component: DvSwitchComponent;
    let fixture: ComponentFixture<DvSwitchComponent>;
    let fall: TSFall;
    ...
    function initTestBed() {
        ...
        fixture = TestBed.createComponent(DvSwitchComponent);
