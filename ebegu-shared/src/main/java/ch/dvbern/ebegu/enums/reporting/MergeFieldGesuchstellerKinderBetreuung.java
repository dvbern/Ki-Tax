...
public enum MergeFieldGesuchstellerKinderBetreuung implements MergeFieldProvider {
	...
	einkommensverschlechterungBasisJahr1Title(new SimpleMergeField<>("einkommensverschlechterungBasisJahr1Title", STRING_CONVERTER)),
	einkommensverschlechterungBasisJahr2Title(new SimpleMergeField<>("einkommensverschlechterungBasisJahr2Title", STRING_CONVERTER)),
	einkommensverschlechterungBasisJahr1AnnuliertTitle(new SimpleMergeField<>("einkommensverschlechterungBasisJahr1AnnuliertTitle", STRING_CONVERTER)),
	einkommensverschlechterungBasisJahr2AnnuliertTitle(new SimpleMergeField<>("einkommensverschlechterungBasisJahr2AnnuliertTitle", STRING_CONVERTER)),
	...
	mzvBeantragtTitle(new SimpleMergeField<>("mzvBeantragtTitle", STRING_CONVERTER)),
	...
	kindIntegrationTitle(new SimpleMergeField<>("kindIntegrationTitle", STRING_CONVERTER)),
	...
	ekvVorhandenBasisJahr1(new SimpleMergeField<>("ekvVorhandenBasisJahr1", BOOLEAN_X_CONVERTER)),
	ekvVorhandenBasisJahr2(new SimpleMergeField<>("ekvVorhandenBasisJahr2", BOOLEAN_X_CONVERTER)),
	ekvAnnuliertBasisJahr1(new SimpleMergeField<>("ekvAnnuliertBasisJahr1", BOOLEAN_X_CONVERTER)),
	ekvAnnuliertBasisJahr2(new SimpleMergeField<>("ekvAnnuliertBasisJahr2", BOOLEAN_X_CONVERTER)),
	...
	mzvBeantragt(new SimpleMergeField<>("mzvBeantragt", BOOLEAN_X_CONVERTER)),
	...
	kindIntegration(new SimpleMergeField<>("kindIntegration", STRING_CONVERTER)),
