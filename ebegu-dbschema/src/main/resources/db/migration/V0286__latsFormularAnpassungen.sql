...
alter table lastenausgleich_tagesschule_angaben_gemeinde add column mindestens50prozent_betreuungszeit_durch_ausgebildetes_personal_bemerkung varchar(255);
alter table lastenausgleich_tagesschule_angaben_gemeinde_aud add column mindestens50prozent_betreuungszeit_durch_ausgebildetes_personal_bemerkung varchar(255);
