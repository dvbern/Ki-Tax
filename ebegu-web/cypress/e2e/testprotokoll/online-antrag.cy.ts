...
describe('Kibon - generate Testfälle [Online-Antrag]', () => {
    ...
    it('should correctly create a new online antrag', () => {
        ...
        //Familiensituation
        {
            AntragFamSitPO.getPageTitle().should(
                'have.text',
                'Familiensituation'
            );
            cy.url()
        ...
        //Betreuung
        {
            ...
            //TFO
            {
                ...
                AntragBetreuungPO.fillOnlineTfoBetreuungsForm(
                    'withValid',
                    'London',
                    {mobile: true}
                );
        ...
        // FINANZIELLE VERHAELTNISSE
        {
            ...
            // Resultate
            {
                FinanzielleSituationResultatePO.fillFinSitResultate(
                    'withValid'
                );
        ...
        // !!!!!! - New User - !!!!!!
        {
            ...
            cy.waitForRequest(
                'GET',
                '**/fachstellen/erweiterteBetreuung',
                () => {
            ...
            cy.getDownloadUrl(() => {
                ...
                return cy
                    ...
                    .then(response =>
                        ...
                        ).to.match(/Freigabequittung_.*\.pdf/)
                    );
            });
        }
