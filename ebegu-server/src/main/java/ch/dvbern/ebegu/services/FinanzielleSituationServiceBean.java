...
@RolesAllowed({ SUPER_ADMIN, ADMIN_BG, SACHBEARBEITER_BG, JURIST, REVISOR, GESUCHSTELLER, STEUERAMT, SACHBEARBEITER_TS, ADMIN_TS })
public class FinanzielleSituationServiceBean extends AbstractBaseService implements FinanzielleSituationService {
	...
	@Nonnull
	@Override
	@RolesAllowed({ SUPER_ADMIN, ADMIN_BG, SACHBEARBEITER_BG, GESUCHSTELLER, SACHBEARBEITER_TS, ADMIN_TS })
	...
	@Nonnull
	@Override
	@RolesAllowed({ SUPER_ADMIN, ADMIN_BG, SACHBEARBEITER_BG, JURIST, REVISOR, GESUCHSTELLER, STEUERAMT, ADMIN_TS, SACHBEARBEITER_TS })
	...
	@Override
	@Nonnull
	@RolesAllowed({ SUPER_ADMIN, ADMIN_BG, SACHBEARBEITER_BG, JURIST, REVISOR, GESUCHSTELLER, STEUERAMT, SACHBEARBEITER_INSTITUTION,
