...
@Stateless
@LocalBean
public class WSSSecurityKibonAnfrageAssertionExtractionHandler implements SOAPHandler<SOAPMessageContext> {
	private static final Logger LOGGER = LoggerFactory.getLogger(WSSSecurityKibonAnfrageAssertionExtractionHandler.class.getSimpleName());
