...
public class KindServiceBeanTest extends AbstractEbeguLoginTest {
	...
	public void addKindInMutationTest() {
		...
		kindService.saveKind(neuesKindInMutation, null);
	...
	private KindContainer persistKind(Gesuch gesuch) {
		...
		for (PensumFachstelle pensumFachstelle : kindContainer.getKindGS().getPensumFachstelle()) {
			pensumFachstelle.setKind(kindContainer.getKindGS());
		...
		final KindContainer persistedKind = kindService.saveKind(kindContainer, null);
