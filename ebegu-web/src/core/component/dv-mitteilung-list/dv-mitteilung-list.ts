...
export class DVMitteilungListController {
    ...
    public getBgNummer(): string {
        let bgNummer: string = '';
        if (this.betreuung) {
            bgNummer = this.ebeguUtil.calculateBetreuungsId(this.betreuung.gesuchsperiode, this.dossier.fall, this.dossier.gemeinde, this.betreuung.kindNummer, this.betreuung.betreuungNummer);
        }
        return bgNummer;
    }
    ...
    public betreuungAsString(mitteilung: TSMitteilung): string {
        ...
        if (mitteilung.betreuung) {
            let bgNummer: string = this.ebeguUtil.calculateBetreuungsId(mitteilung.betreuung.gesuchsperiode, mitteilung.dossier.fall, mitteilung.dossier.gemeinde,
