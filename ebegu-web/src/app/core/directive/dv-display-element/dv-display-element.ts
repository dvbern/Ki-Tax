 ...
 *     dv-display-allowed-roles="[vm.TSRole.X, vm.TSRole.Y, ...]" - Array mit allen Rollen, für die das Element
 ...
 * auch eine Methode oder eine Variable uebergeben dv-display-expression - optionale Attribute, mit der man einen extra
