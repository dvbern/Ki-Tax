...
describe('wizardStepManager', () => {
    ...
    describe('construct the object', () => {
        ...
        it('constructs the steps for JA', () => {
            ...
            expect(wizardStepManager.getAllowedSteps()[11]).toBe(TSWizardStepName.FINANZIELLE_SITUATION_APPENZELL);
            expect(wizardStepManager.getAllowedSteps()[12]).toBe(TSWizardStepName.FINANZIELLE_SITUATION_SCHWYZ);
            expect(wizardStepManager.getAllowedSteps()[13]).toBe(TSWizardStepName.EINKOMMENSVERSCHLECHTERUNG);
            expect(wizardStepManager.getAllowedSteps()[14]).toBe(TSWizardStepName.EINKOMMENSVERSCHLECHTERUNG_LUZERN);
