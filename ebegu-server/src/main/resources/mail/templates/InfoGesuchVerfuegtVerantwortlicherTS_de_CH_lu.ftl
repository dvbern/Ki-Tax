...
<head>
	...
	<title>kiBon - Betreuungsgutschein wurde bestätigt</title>
...
<div>
	...
	<p>
		Der Antrag mit der Fallnummer ${gesuch.dossier.fall.fallNummer} wurde bestätigt. Es können nun auch die
