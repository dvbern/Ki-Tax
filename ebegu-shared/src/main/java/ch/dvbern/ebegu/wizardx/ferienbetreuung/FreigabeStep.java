...
public class FreigabeStep implements WizardStep<FerienbetreuungWizard> {

	@Override
	public void next(@Nonnull FerienbetreuungWizard wizard) {
		wizard.setStep(new VerfuegungStep());
	}
	...
	public String getWizardStepName() {
		return FerienbetreuungWizardStepsEnum.FREIGABE.name();
	}
